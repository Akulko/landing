/* jquery.selectorr v0.2 | (c) @ajlkn | MIT licensed */ ! function(e) {
    e.fn.selectorr = function(t) {
        ...
        (l = n.filter(".active")).length > 0 && (o = l.index()), n.each(function(t) {
            ...
            r = u.find(i.titleSelector), f = r.attr("href"), l = e('<li class="title">' + r.text() + "</li>"), c.append(l), r.remove(), l.css("cursor", "pointer"), u.wrapInner('<div class="panel" />'), n = u.children("div"), n.appendTo(d), l.on("click", function(e) {
